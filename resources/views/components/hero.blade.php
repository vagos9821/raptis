    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div class="text-center">
                <h1 class="text-gray-900 text-4xl font-bold tracking-tight sm:text-6xl">Η επιχείρηση μας ασχολείται με
                    τις χάρτινες & πλαστικές τσάντες από το 1991 με ιδιαίτερη επιτυχία!</h1>
                <p class="text-gray-600 mt-6 text-lg leading-8">
                    <span class="underline">Είμαστε κάθετη μονάδα.</span>
                    Κατέχουμε όλο το πακέτο της
                    συσκευασίας. Δημιουργούμε, τυπώνουμε, κατασκευάζουμε & παράγουμε τα προιόντα για να εξυπηρετήσουμε
                    τις ανάγκες των επιχειρήσεων.
                </p>
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="#contact-us"
                        class="bg-accent rounded-md px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors duration-200 ease-in-out hover:bg-primary hover:text-accent focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent">Επικοινωνία</a>
                    <a href="#about-us"
                        class="text-gray-900 text-sm font-semibold leading-6 transition-colors duration-200 ease-in-out hover:text-accent">Για
